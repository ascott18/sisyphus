                    ...
                    <div class="panel-body">
                        ...
                        <table class="list-group" style="width: 100%">
                            ...
                            <tr class="list-group-item" ng-repeat="course in courses">
                                <td style="width: 100%">
                                    <h4 class="list-group-item-heading">[[course.department]]
                                        [[course.course_number]]-[[course.course_section]] [[course.course_name]]</h4>
                                    ...
                                    <div ng-show="courseNeedsOrders(course)">
                                            ...
                                            <span class="well well-sm"
                                                  style="background-color: #fcf8e3; border-color: #fbeed5">
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div>
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#newbook" aria-controls="newbook"
                                                                          role="tab" data-toggle="tab">New Book</a></li>
                                <li role="presentation"><a href="#pastbooks" aria-controls="pastbooks" role="tab"
                                                           data-toggle="tab">Past Books</a></li>
                            </ul>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="newbook">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="bookTitle"
                                               placeholder="Book Title" ng-model="book.title">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="publisher"
                                                   placeholder="Publisher" ng-model="book.publisher">
                                        </div>
