...
<div id="wrapper">
    ...
    <nav role="navigation" class="navbar navbar-fixed-top">
        ...
        <div class="navbar-header">
            <button type="button" data-toggle="collapse" data-target=".navbar-ex1-collapse" class="navbar-toggle"><span
                        class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span
                        class="icon-bar"></span><span class="icon-bar"></span></button>
            <a href="/" class="navbar-brand">
                <img src="/images/logoWhite.png" width="186" height="60">

                <div style="padding-left: 20px; margin-top: 10px" class="pull-right">
                    <div>Computer Science Department</div>
                    <div style="margin-top: 7px">
                        <small>Book Ordering System</small>
                    </div>
                </div>
            </a>
        </div>
